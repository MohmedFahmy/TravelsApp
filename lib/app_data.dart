...
export 'package:travels_app/app_data.dart';
...
const Trips_data = const [
  Trip(
    ...
    program: [
      'Alayite, situate yourself in a state of confusion and uncertainty at the dollar magna aliquia.',
      'Isking Alite Set of Iosmood Tempor Uncaided Labor at Dollar Magna Aliquia.',
      'Lorem Ipsum Dollar at Dollar Magna Aliqua.',
      'Lore du iosmode tempur ancadédienteut labor et dollar magna aliquia',
      ' ipsum dollar set amet,contracteur adaiba yesking allite,set du iosmode tempur uncaidediontute labor at dollar magnalorem aliquia.',
      'Lorem Ipsum Dollar Set Amit, Tempor Uncaided Identity Labor At Dollar Magna Aliqua.',
    ],
    isInSummer: false,
    isForFamilies: true,
    isInWinter: true,
  ...
  Trip(
    ...
    program: [
      'Alliate,set du iosmod tempor encaidedionteut labor at dollar magna aliequia.',
      'using aliite site du iosmood tempur ancaidedinteut labor at dollar magna aliequia.',
      'Lorem ipsum dollar at dollar magna aliequiwa. At Dollar Magna Aliquia.',
    ],
    isInSummer: false,
    isForFamilies: false,
    isInWinter: false,
  ...
  Trip(
    ...
    program: [
      'Alliate,set du iosmod tempor encaidedionteut labor at dollar magna aliequia.',
      'using aliite site du iosmood tempur ancaidedinteut labor at dollar magna aliequia.',
      'Lorem ipsum dollar at dollar magna aliequiwa. '
          'At Dollar Magna Aliquia',
    ],
    isInSummer: true,
    isForFamilies: true,
    isInWinter: true,
